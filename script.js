...
coolform
  .directive('coolForm', function($timeout) {
    var ctrl = function($scope, $element, $attributes) {
      ...
      $scope.questions.push({'question': 'Ingrese su nombre:'});
      $scope.questions.push({'question': 'Ingrese su Nro de Celular:'});
      $scope.questions.push({'question': 'En que empresa trabaja:'});
